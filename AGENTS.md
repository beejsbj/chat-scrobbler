...
Shared guide for any coding agent working in this repo. `CLAUDE.md` is a symlink
to this file, so both surfaces read the same instructions.
...
`INGEST_TOKEN`, `BACKUP_TARGET`, `BIND_HOST`).
